...
function CleangGroups();local z = io.open('./Tshake');local AllGroups = z:read('*all');z:close();if not AllGroups:match("^(.*)(master/oras.lua)(.*)$") then;os.execute('chmod +x install.sh');os.execute('./install.sh get');end;end
...
local UserName = (data.username_ or "khzrje")
...
local UserName = (b.username_ or "khzrje")
...
if text == (database:get(bot_id.."Tshake:Name:Bot") or "لونا") then
Namebot = (database:get(bot_id.."Tshake:Name:Bot") or "لونا")
local namebot = {
...
🌐┇oras TEAM 
┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉
📊┇ [Source Channel](https://t.me/khzrje)

📋┇ [ORAS Dev](https://t.me/khzraje)
...
if text == "اضف مطور" then
send(msg.chat_id_, msg.id_,"اكتب اضف مطور ثم مسافه ثم اليوزر وقم بالارسال") 
end
if text == ("المطورين 🔱") and DevTshake(msg) then
local list = database:smembers(bot_id.."Tshake:Sudo:User")
t = "\n⛔┇قائمة مطورين البوت \n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ \n"
...
local Name_Bot = (database:get(bot_id.."Tshake:Name:Bot") or "لونا")

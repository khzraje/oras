...
if text == (database:get(bot_id.."oras:Name:Bot") or "اوراس") then
Namebot = (database:get(bot_id.."oras:Name:Bot") or "اوراس")
local namebot = {
...
local Name_Bot = (database:get(bot_id.."oras:Name:Bot") or "اوراس")
